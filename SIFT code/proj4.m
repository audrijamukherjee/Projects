...
%%%%Extra credit- Randomly chosen train and test images
%acc=zeros(100,1);
%num_runs=70;
%for run=1:num_runs
% fprintf('Randomly choosing train and test image paths');
% num_train=size(train_image_paths,1);
% rand_train=rand(100,1);
% rand_train=ceil(num_train*rand_train);
% train_image_paths=train_image_paths(rand_train);
% train_labels=train_labels(rand_train);
% 
% num_test=size(test_image_paths,1);
% rand_test=rand(100,1);
% rand_test=ceil(num_test*rand_test);
% test_image_paths=test_image_paths(rand_test);
% test_labels=test_labels(rand_train);
%train_image_paths=cat(1, train_image_paths, test_image_paths);
...
%                     range2=range;
%                 else
%                     range2=cat(2,range2,range+i*100);
%                 end
%             end
%             range2=range2.';
%             train_image_paths=train_image_paths(range2);
%             test_image_paths=test_image_paths(range2);
%             %Remove till here
...
%             test_labels=test_labels(range2);
%             
...
% acc(run)=create_results_webpage( train_image_paths, ...
%                         test_image_paths, ...
%                         train_labels, ...
%                         test_labels, ...
%                         categories, ...
